...
describe('Task CRUD Operations', () => {
	...
	describe('Delete Task', () => {
		it('soft deletes task', async () => {
			...
			const deletedTask = { ...task, status: 'deleted' as const, updatedAt: new Date().toISOString() };
		...
		it('restores soft-deleted task', async () => {
			...
			// Simulate restore
			const restoredTask = { ...deletedTask, status: 'todo' as const, updatedAt: new Date().toISOString() };
